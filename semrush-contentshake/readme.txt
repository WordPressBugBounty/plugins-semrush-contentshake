...
With just one click, you can publish your article directly to the WordPress site.

== Installation ==
1. Upload the entire `contentshake` folder to the `/wp-content/plugins/` directory;
1. Activate the plugin through the \'Plugins\' menu in WordPress.

== Screenshots ==
1. Generate relevant content ideas with Semrush data
2. Use AI to write content faster and paraphrase blocks of text
3. Get data-driven suggestions for your content’s SEO, readability, and tone of voice
4. Publish articles directly to WordPress without leaving the tool
